...
criticOptions = rlRepresentationOptions('Optimizer','adam','LearnRate',1e-3, ... %valor prev 1e-3
...
actorOptions = rlRepresentationOptions('Optimizer','adam','LearnRate',1e-4, ... %valor prev 1e-4
